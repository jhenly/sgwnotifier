...
public class Auction {
	...
	public String toString() {
		...
		return String
				.format("id: %8d  title: %s  curPrice: $%.2f  maxBid: $%.2f  numBids: %2d  endDate: %s",
						this.getId(), this.getTitle(), this.getCurrentPrice(),
						this.getMaxBid(), this.getBids(), this.getEndDate());
	}
